...
export function FooterLink({ type, href, title }: Props) {
  ...
  return (
    <Link
      ...
      } relative rounded px-8 py-5 before:absolute before:top-1/2 before:h-2 before:w-2  before:border-b-2 before:border-l-2 before:border-neutral-500 hover:bg-neutral-100`}
    >
